...
Gem::Specification.new do |spec|
  spec.name          = "mobile_pay-pki"
  spec.version       = MobilePay::PKI::VERSION
  spec.authors       = ['DanskeBank']
  spec.email         = ['mp_appswitch@danskebank.com']

  spec.summary       = 'DanskeBank PKI Factory Ruby client.'
  spec.description   = 'Ruby implementation for how to interact with DanskeBank\'s PKI Factory.'
